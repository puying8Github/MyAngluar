/**
 * Created by ThinkPad User on 2016/4/14.
 */
...
.controller('ctrl_lottery',['$scope','$timeout',function($scope,$timeout){
            ...
            $scope.start=function(){
                ...
                var next=function(key){
                    ...
                    if((key-1)>=0) $scope.items[key-1].status=false;
                    if(key==0) $scope.items[$scope.items.length-1].status=false;
